...
import 'package:mental_health_tracker_mobile/screens/product_detail.dart';
          ...
          if (snapshot.data == null) {
            ...
            if (!snapshot.hasData) {
              return const Column(
                children: [
                  Text(
                    'Belum ada data Product pada E-Daur.',
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("${product.fields.deskripsi}"),
                          const SizedBox(height: 10),
                          Text("${product.fields.rating}"),
                          const SizedBox(height: 10),
